...
[bulgarian]Миналият четвъртък, на 08 Април, Стив Джобс и [Скот Форстал](http://www.apple.com/pr/bios/forstall.html) представиха плановете за новата операционна система на iPhone,  **iPhone OS 4**. Цялото представяне можеш да проследиш на [официалния сайт](http://events.apple.com.edgesuite.net/1004fk8d5gt/event/). Какви са акцентите?
...
[english]Last Thursday, on Apr 08, Steve Jobs and [Scott Forstall](http://www.apple.com/pr/bios/forstall.html) presented the plans for the new iPhone operating system, **iPhone  OS 4**. The event itself can be seen on the [official site](http://events.apple.com.edgesuite.net/1004fk8d5gt/event/). What are the highlights? 
